      ...
      <div className="px-2 sm:px-6 lg:px-48">
        <div className="relative flex h-16 items-center justify-between">
          ...
          <div className="absolute inset-y-0 right-0 flex items-center pr-2 sm:static sm:inset-auto sm:ml-6 sm:pr-0">
            <button type="button" className="me-5 border border-slate-400 hover:border-slate-100 hidden lg:block relative rounded px-5 py-2 bg-gray-800 p-1 text-gray-400 hover:text-white focus:outline-none">
              + Add Listing
            </button>
            <a href="/sign" type="button" className="hidden lg:block relative px-5 py-2 bg-gray-800 hover:text-white text-slate-200 focus:outline-none">
              Sign In
            </a>
            ...
            {/* <div className="relative ml-3">
              ...
              <div className="absolute right-0 z-10 mt-2 w-48 origin-top-right rounded-md bg-white py-1 shadow-lg ring-1 ring-black ring-opacity-5 focus:outline-none" role="menu" aria-orientation="vertical" aria-labelledby="user-menu-button" tabindex="-1">
                <a href="#" className="block lg:hidden px-4 py-2 text-sm text-gray-700" role="menuitem" tabindex="-1" id="user-menu-item-0">See Notifications</a>
                <a href="#" className="block px-4 py-2 text-sm text-gray-700" role="menuitem" tabindex="-1" id="user-menu-item-0">Go to Dashboard</a>
